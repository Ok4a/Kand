...
if __name__ == '__main__':
    ...
    # file_names = ['data/disimprovment/par_shift_jacobi_laplace_sign.txt', 'data/disimprovment/par_shift_jacobi_laplace_median.txt', 'data/disimprovment/par_shift_jacobi_laplace_mean.txt', 'SaveData/shift_laplace_jacobi.txt']
    file_names = ['data/disimprovment/par_shift_jacobi_laplace_sign.txt']
    lines_list = []
