...
if __name__ == '__main__':
    ...
    file_names = ['data/initial par shift test/initial_par_shift_eris1176.txt', 'data/initial par shift test/initial_par_shift_fidap004.txt','data/initial par shift test/initial_par_shift_orsirr_1.txt', 'data/initial par shift test/initial_par_shift_sherman5.txt']
    lines_list = []
