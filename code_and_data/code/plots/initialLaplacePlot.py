...
if __name__ == '__main__':
    ...
    file_names = ['data/laplace matrix/laplace_data_15.txt','data/laplace matrix/laplace_data_25.txt','data/laplace matrix/laplace_data_35.txt','data/laplace matrix/laplace_data_45.txt']
