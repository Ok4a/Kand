...
if __name__ == '__main__':
    ...
    file_names = ['data/learning scale/initial_par_shift_learn_scale_eris1176.txt','data/learning scale/initial_par_shift_learn_scale_fidap004.txt','data/learning scale/initial_par_shift_learn_scale_orsirr_1.txt','data/learning scale/initial_par_shift_learn_scale_sherman5.txt']
