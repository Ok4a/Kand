...
if __name__ == '__main__':
    ...
    file_names = ['finalData/learning scale/initial_par_shift_learn_scale_eris1176.txt','finalData/learning scale/initial_par_shift_learn_scale_fidap004.txt','finalData/learning scale/initial_par_shift_learn_scale_orsirr_1.txt','finalData/learning scale/initial_par_shift_learn_scale_sherman5.txt']
    # file_names = ['SaveData/super_sub/diag_shift_jacobi_laplace_sign_1.txt']
    lines_list = []
    lines_list.append({'train': [37], 'test': [67]})
    lines_list.append({'train': [37], 'test': [55]})
    lines_list.append({'train': [37], 'test': [65]})
