...
if __name__ == '__main__':
    ...
    file_names = ['finalData/initial Learn/initial_par_shift_learn_eris1176.txt','finalData/initial Learn/initial_par_shift_learn_fidap004.txt','finalData/initial Learn/initial_par_shift_learn_orsirr_1.txt','finalData/initial Learn/initial_par_shift_learn_sherman5.txt']
